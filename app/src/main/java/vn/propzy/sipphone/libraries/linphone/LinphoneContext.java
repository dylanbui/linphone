 ...
 */
package vn.propzy.sipphone.libraries.linphone;
...
import vn.propzy.sipphone.BuildConfig;
...
import vn.propzy.sipphone.libraries.linphone.notifications.NotificationsManager;
...
import vn.propzy.sipphone.libraries.linphone.utils.PushNotificationUtils;
...
//        }
    ...
    private void onIncomingReceived() {
        ...
        Intent intent = new Intent(mContext, CustomCallIncomingActivity.class);
